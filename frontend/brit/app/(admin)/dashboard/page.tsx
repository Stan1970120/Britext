// frontend/brit/app/(admin)/dashboard/page.tsx
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 p-6 space-y-8 text-gray-900 relative">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
        ...
        <div 
          className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm transition-all duration-300 relative overflow-hidden"
        >
          <div className="flex justify-between items-start">
            ...
            <button 
              onClick={() => router.push("/dashboard/published-blogs")}
              className="bg-sky-50 text-sky-600 p-4 rounded-2xl hover:bg-sky-600 hover:text-white transition-all duration-300 flex items-center justify-center group"
              title="View Published Blogs"
            >
