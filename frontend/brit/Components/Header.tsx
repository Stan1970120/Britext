...
const Header = () => {
  ...
  const handleLogout = async () => {
    const targetUrl = user?.role === "admin" ? "/404" : "/";
    try {
      setIsLoggingOut(true);
      setMobileMenuOpen(false);
      await logout(targetUrl);
    } catch (error) {
    ...
    <header className="w-full bg-white shadow-sm py-3 px-4 sm:px-6 md:px-8 relative z-50">
      <div className="w-full flex items-center justify-between">
        ...
        <div className="flex items-center">
          <div className="flex flex-col items-center">
            <button
              type="button"
              onClick={() => router.push("/")}
              className="relative h-9 w-28 sm:h-10 sm:w-40 cursor-pointer font-black text-left"
            >
              <Image
        ...
        <div className="flex justify-center items-center flex-1 px-2" style={{ perspective: "1000px" }}>
          <div className="relative h-10 w-24 xs:w-28 sm:w-32 md:h-12 md:w-40 transition-transform duration-500 [transform-style:preserve-3d]">
            {/* Front Side */}
            <div className="absolute inset-0 bg-[#035b77] text-white rounded-md flex flex-col items-center justify-center font-bold px-1 text-center shadow-md [backface-visibility:hidden] select-none border border-[#024a61]">
            ...
            {/* Back Side */}
            <div className="absolute inset-0 bg-white text-gray-900 rounded-md flex items-center justify-center font-bold px-1 text-center shadow-md [backface-visibility:hidden] [transform:rotateY(180deg)] select-none border border-[#035b77]">
              <span className="text-[9px] xs:text-[11px] sm:text-sm tracking-wide">
                <span className="text-[#035b77]">Enjoy</span>Reads
              </span>
            </div>
          </div>
        ...
        <div className="hidden md:flex items-center gap-6 text-gray-700 text-sm">
          ...
          {displayUser ? (
            <div className="flex items-center gap-4 border-l pl-6">
              ...
              >
                <div className="w-8 h-8 bg-[#035b77] text-white rounded-full flex items-center justify-center text-xs font-bold uppercase">
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="absolute top-full left-0 right-0 bg-white shadow-xl flex flex-col p-6 space-y-6 md:hidden border-t">
          {displayUser && (
            <div className="border-b pb-4">
              <p className="text-sm text-gray-500">Logged in as</p>
              <p className="font-bold text-[#035b77]">
